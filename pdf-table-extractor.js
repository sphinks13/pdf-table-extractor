let id, item, x, y, width, height, edge, edges1, edges2, line, new_lines, news_lines, tables, table_pos, page_tables, hor, col, left_col, right_col, ver, row, top_row, bottom_row, x_list;
...
export function pdf_table_extractor(doc){
