let id, item, x, y, width, height, edge, edges1, edges2, line, new_lines, news_lines, tables, table_pos, hor, col, left_col, right_col, ver, row, top_row, bottom_row, x_list;
